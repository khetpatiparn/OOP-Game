...
public class Map4 extends JPanel{
    ...
    protected final int START_X = 210;
    protected final int START_Y = 580;

    // Goal positions Setup
    protected final int GOAL_X = 990;
    protected final int GOAL_Y = 490;

    // Construct Box
    private Color colorBox = new Color(126,217,87,255);
    ...
    private Rectangle o1 = new Rectangle(360,300,630,630);
    private Rectangle o2 = new Rectangle(980,540,300,130);

    // Construct obstacles Moving
    private ObjectMoving M1 = new ObjectMoving(360, 20, 50, 100);
    private ObjectMoving M2 = new ObjectMoving(430, 20, 50, 100);
    private ObjectMoving M3 = new ObjectMoving(500, 20, 50, 100);
    private ObjectMoving M4 = new ObjectMoving(570, 20, 50, 100);
    private ObjectMoving M5 = new ObjectMoving(640, 20, 50, 100);
    private ObjectMoving M6 = new ObjectMoving(710, 20, 50, 100);
    private ObjectMoving M7 = new ObjectMoving(400, 240, 150, 50);
    private ObjectMoving M8 = new ObjectMoving(400, 480, 150, 50);
    private ObjectMoving M9 = new ObjectMoving(400, 400, 150, 50);
    private ObjectMoving M10 = new ObjectMoving(400, 320, 150, 50);

    // private Rectangle o3 = new Rectangle(40,90,140,130);    

    // Construct obstables Rotation

    public Map4(GameFrame gameFrame){
        ...
        mapNumber.setText("MAP 4");
        mapNumber.setBounds(500, 385, 400, 100);
        ...
        ActionListener updateTask = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                M1.moveUp2Down(20,290,2);
                M2.moveUp2Down(20,290,2);
                M3.moveUp2Down(20,290,3);
                M4.moveUp2Down(20,290,3);
                M5.moveUp2Down(20, 290, 4);
                M6.moveUp2Down(20, 290, 4);
                M7.moveLeft2Right(400, 1200, 8);
                M8.moveLeft2Right(-60, 360, 4);
                M9.moveLeft2Right(-60, 360, 4);
                M10.moveLeft2Right(-60, 360, 4);
                repaint();
            }
        };
    ...
    protected void paintComponent(Graphics g) {
        ...
        M7.paintMovingObject(g2d);
        M8.paintMovingObject(g2d);
        M9.paintMovingObject(g2d);
        M10.paintMovingObject(g2d);
    }
    ...
    private class MouseAction extends MouseAdapter{
        ...
        private void winGoal(){
            ...
            if (player.boxChar.intersects(goal.goalChar)){
                ...
                // repaint();
                changeMap(gameFrame.map5);
            }
        }
        private void changeMap(JPanel newMap){
            gameFrame.cp.remove(gameFrame.map4);
    ...
    private void Collistion(){
        ...
        if (player.boxChar.intersects(M1.object) || player.boxChar.intersects(M2.object)
            ...
            || player.boxChar.intersects(M7.object) || player.boxChar.intersects(M8.object)
            || player.boxChar.intersects(M9.object) || player.boxChar.intersects(M10.object)){
            // Reset State
            ResetPlayer();
        }
