...
public class TitleGameScreen extends JPanel{
    ...
    public TitleGameScreen(){
        ...
        // addMouseListener(new StartGame());
    }
    ...
    // public class StartGame extends MouseAdapter{
    //     @Override
    //     public void mouseClicked(MouseEvent e) {
    //         super.mouseClicked(e);
    //         if (GameStart.isShowing() && GameStart.getBounds().contains(e.getPoint())){
    //             System.out.println("Clicked Game Start");
    //         }else if (Credits.isShowing() && Credits.getBounds().contains(e.getPoint())){
    //             System.out.println("Clicked Credits");
    //         }else if (Exit.isShowing() && Exit.getBounds().contains(e.getPoint())){
